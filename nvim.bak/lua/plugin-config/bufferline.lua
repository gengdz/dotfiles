...
-- 关闭当前buffer
vim.api.nvim_set_keymap("n", "<leader>bd", ":bdelete %<CR>:BufferLineGoToBuffer 1<CR>", {noremap = true, silent = true})
...
vim.api.nvim_set_keymap("n", "K", ":BufferLineCycleNext<CR>", {noremap = true, silent = true})
